...
create or replace tag 
    ...
    --Tag: Like a metadata annotation that can be attached to columns/tables.
    --common.pii_policy_tag → Custom tag for sensitive information classification.
    -- allowed_values → Restricts values to 'PII','PRICE','SENSITIVE','EMAIL'.
...
--sql command to check data in stage
select 
